<nav class="md:p-4">
    <div class="fixed top-0 left-0 right-0 bg-gray-900 z-50 md:relative md:bg-transparent">
        <div class="container mx-auto flex justify-between items-center p-4">
            <!-- Logo on the left -->
            <div class="flex items-center">
                <img src="{{ asset('images/hitmaster.png') }}" alt="HitMaster Arcade Logo" class="h-13 md:h-13">
            </div>
            ...
            <div class="hidden md:flex flex-grow justify-center">
                <ul class="flex space-x-4"
                    ...
                    <li><a href="{{ route('home') }}"
                            class="text-white hover:text-gray-300">{{ __('messages.home') }}</a></li>
                    <li><a href="{{ route('about') }}"
                            class="text-white hover:text-gray-300">{{ __('messages.about') }}</a></li>
            ...
            <div class="hidden md:flex items-center space-x-4">
                ...
                <div class="relative">
                    ...
                    <div id="profileMenu" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-2 hidden">
                        ...
                        @elseif (auth()->check())
                            <span class="block px-4 py-2 text-gray-800">{{ auth()->user()->nickname }}</span>
    ...
    <!-- Mobile menu -->
    <div id="mobileMenu" class="md:hidden hidden bg-gray-800 fixed top-16 left-0 right-0 bottom-0 z-40 overflow-y-auto">
