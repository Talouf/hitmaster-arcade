...
<div class="container mx-auto py-8">
    ...
    <div id="profile" class="tab-content">
        ...
        <div class="mt-8 max-w-lg mx-auto p-8 rounded shadow-lg">
            <h3 class="text-2xl font-bold text-center mb-4">Abonnement à la Newsletter</h3>
...
<div id="shipping" class="tab-content" style="display: none;">
    ...
    <div class="text-center mt-4">
        <a href="{{ route('profile.add-shipping-info') }}" class="bg-blue-500 text-white px-4 py-2 rounded">Ajouter un
                    ...
                    <tr class="border-b border-gray-700">
                        ...
                        <td class="py-2 px-4 text-white">
                            <a href="{{ route('orders.show', $order->id) }}"
                                class="bg-blue-500 text-white px-2 py-1 rounded mr-2">Détails</a>
                            <a href="{{ route('orders.invoice', $order->id) }}"
                                class="bg-green-500 text-white px-2 py-1 rounded">Facture</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
